    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <p class="mt-3 text-xs text-gray-500">Allowance & earnings</p>
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <p class="mt-3 text-xs text-gray-500">Total expenses</p>
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center">
                            <div
                                class="flex-shrink-0 {{ $personalBalance >= 0 ? 'bg-blue-100' : 'bg-orange-100' }} rounded-md p-3">
                                <svg class="h-6 w-6 {{ $personalBalance >= 0 ? 'text-blue-600' : 'text-orange-600' }}"
                        ...
                        <p class="mt-3 text-xs {{ $personalBalance >= 0 ? 'text-green-600' : 'text-orange-600' }}">
                    ...
                    <div class="p-6">
                        ...
                        <div class="relative pt-1">
                            <div class="flex mb-2 items-center justify-between">
                                <div>
                                    <span
                                        class="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full {{ $savingsRate >= 50 ? 'text-green-600 bg-green-200' : ($savingsRate >= 20 ? 'text-yellow-600 bg-yellow-200' : 'text-red-600 bg-red-200') }}">
                                        Savings Rate
                                    </span>
                                </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-900 mb-4">My Spending by Category</h3>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="p-6">
                            ...
                            @else
                                <div class="text-center py-12">
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">Start tracking your allowance and spending!</p>
                                    <div class="mt-6">
                ...
                <div class="lg:col-span-1">
                        ...
                        <div class="p-6">
                                ...
                                <div class="space-y-4">
                                    @foreach($expenseByCategory as $item)
                                        <div class="flex justify-between items-start">
                                            <div class="flex-1">
                                                <div class="text-sm font-medium text-gray-900">{{ $item->category->name }}
                                                </div>
                            ...
                            @else
                                <div class="text-center py-8">
                                    ...
                                    <p class="mt-2 text-sm text-gray-500">No expenses tracked yet</p>
                                </div>
                            @endif
                        </div>
                    </div>
                    ...
                    {{-- Savings Tip --}}
                    <div
                        class="mt-4 bg-gradient-to-br from-yellow-50 to-orange-50 border border-yellow-200 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-4">
                            <div class="flex items-start">
                                ...
                                <div class="ml-3">
                                    <h4 class="text-sm font-medium text-yellow-800">Pro Tip</h4>
                                    <p class="mt-1 text-xs text-yellow-700">Save at least 20% of your allowance every
                                        month to
