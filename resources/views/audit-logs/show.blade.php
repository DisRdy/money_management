            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-3">
                                    ...
                                    <div class="text-xs text-gray-500">{{ ucfirst($auditLog->user->role ?? 'N/A') }}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        {{-- Target User --}}
                        <div>
                            <label class="block text-sm font-medium text-gray-500 mb-1">Record Owner</label>
                            @if($auditLog->targetUser)
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3">
                                        <div class="text-sm font-medium text-gray-900">{{ $auditLog->targetUser->name }}
                                        </div>
                                        <div class="text-xs text-gray-500">{{ ucfirst($auditLog->targetUser->role) }}</div>
                                    </div>
                                </div>
                            @else
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-900 truncate" title="{{ $auditLog->user_agent }}">
                    ...
                    @if($auditLog->action === 'updated')
                        <div class="border-t border-gray-200 pt-6">
                            <h4 class="text-sm font-semibold text-gray-900 mb-4">Changes Made</h4>
                                    ...
                                    <thead class="bg-gray-100">
                                        <tr>
                                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">
                                                Field</th>
                                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Old
                                                Value</th>
                                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">New
                                                Value</th>
                                        </tr>
                                    </thead>
                    ...
                    @if($auditLog->action === 'created' && $auditLog->new_values)
                        <div class="border-t border-gray-200 pt-6">
                            <h4 class="text-sm font-semibold text-gray-900 mb-4">Created Data</h4>
                    ...
                    @if($auditLog->action === 'deleted' && $auditLog->old_values)
                        <div class="border-t border-gray-200 pt-6">
                            <h4 class="text-sm font-semibold text-gray-900 mb-4">Deleted Data</h4>
