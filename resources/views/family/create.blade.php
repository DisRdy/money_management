                ...
                <div class="p-6">
                    ...
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <span class="font-semibold text-indigo-600 dark:text-indigo-400">{{ Auth::user()->tenant->name }}</span> family.
                        </p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('family.store') }}">
                        ...
                        <div class="mb-5">
                            ...
                            @error('email')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @else
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">This email will be used for login.</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="space-y-3">
                                {{-- Wife Option --}}
                                <label class="flex items-start p-4 border-2 rounded-lg cursor-pointer transition-colors {{ old('role') === 'wife' ? 'border-purple-500 bg-purple-50 dark:bg-purple-900/30' : 'border-gray-200 dark:border-gray-600 hover:border-purple-300 dark:hover:border-purple-500' }}">
                                    <input type="radio" 
                                           name="role" 
                                           value="wife" 
                                    ...
                                    <div class="ml-3">
                                        <div class="flex items-center">
                                            <span class="text-sm font-semibold text-gray-900 dark:text-gray-100">💼 Wife</span>
                                        </div>
                                ...
                                {{-- Child Option --}}
                                <label class="flex items-start p-4 border-2 rounded-lg cursor-pointer transition-colors {{ old('role') === 'child' ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/30' : 'border-gray-200 dark:border-gray-600 hover:border-blue-300 dark:hover:border-blue-500' }}">
                                    <input type="radio" 
                                           name="role" 
                                           value="child" 
                                    ...
                                    <div class="ml-3">
                                        <div class="flex items-center">
                                            <span class="text-sm font-semibold text-gray-900 dark:text-gray-100">🎓 Child</span>
                                        </div>
                                        <p class="mt-1 text-xs text-gray-600 dark:text-gray-400">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="password" 
                                   ...
                                   required
                                   minlength="8"
                                   class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('password') border-red-500 @enderror">
                            @error('password')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @else
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Minimum 8 characters. This will be the login password for the new member.</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Re-enter the password to confirm.</p>
                        </div>
                        ...
                        <div class="mb-6 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 rounded-lg p-4">
                            <div class="flex items-start">
                                ...
                                <div class="ml-3">
                                    <h4 class="text-sm font-medium text-blue-800 dark:text-blue-200">Important</h4>
