    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                        ...
                        <div class="flex flex-col sm:flex-row items-center sm:items-end -mt-16 sm:-mt-12">
                            ...
                            <div class="sm:ml-6 text-center sm:text-left flex-1">
                                <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-gray-100">
                                    {{ $user->name }}
                                    @if($user->id === Auth::id())
                                        <span class="text-lg text-indigo-600 dark:text-indigo-400">(You)</span>
                                    @endif
                                </h1>
                                <div class="mt-2">
                                    @if($user->isOwner())
            ...
            <div
                class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg border border-gray-200 dark:border-gray-700 mb-6">
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Member Information</h3>
                    ...
                    <div class="space-y-4">
                        ...
                        <div
                            ...
                            <div class="sm:w-2/3 mt-1 sm:mt-0">
                                <span
                                    class="text-sm text-gray-900 dark:text-gray-100 font-semibold">{{ $user->name }}</span>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="sm:w-2/3 mt-1 sm:mt-0">
                                <span
                                    class="text-sm text-gray-900 dark:text-gray-100 font-medium capitalize">{{ $user->role }}</span>
                            </div>
                        </div>
                        ...
                        <div
                            class="flex flex-col sm:flex-row sm:items-center py-3 border-b border-gray-200 dark:border-gray-700">
                            <div class="sm:w-1/3">
                                <span class="text-sm font-medium text-gray-500 dark:text-gray-400">Family</span>
                            </div>
                            <div class="sm:w-2/3 mt-1 sm:mt-0">
                                <span
                                    class="text-sm text-gray-900 dark:text-gray-100 font-semibold">{{ $user->tenant->name }}</span>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center py-3">
                            ...
                            <div class="sm:w-2/3 mt-1 sm:mt-0">
                                <span
                                    class="text-sm text-gray-900 dark:text-gray-100">{{ $user->created_at->format('d F Y') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            @else
                ...
                <div
                    ...
                    <div class="flex items-start">
                        <svg class="h-5 w-5 text-yellow-400 dark:text-yellow-300 mt-0.5" fill="currentColor"
                            viewBox="0 0 20 20">
                        ...
                        <div class="ml-3">
                            <h4 class="text-sm font-medium text-yellow-800 dark:text-yellow-200">Owner Account Protection
                            </h4>
