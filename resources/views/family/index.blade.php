        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-600">Add and view members in your family ({{ Auth::user()->tenant->name }})</p>
                </div>
                ...
                <div class="p-6">
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach($members as $member)
                                        <tr class="hover:bg-gray-50 cursor-pointer transition-colors duration-150" onclick="window.location='{{ route('family.show', $member) }}'">
                        ...
                        <div class="mt-6 pt-4 border-t border-gray-200">
                            <div class="flex items-center justify-between text-sm">
                                <span class="text-gray-600">
                                    Total Members: <span class="font-semibold text-gray-900">{{ $members->count() }}</span>
                                </span>
                                <div class="flex gap-4">
                                    <span class="text-gray-600">
                                        Owner: <span class="font-semibold">{{ $members->where('role', 'owner')->count() }}</span>
                                    </span>
                                    <span class="text-gray-600">
                                        Wife: <span class="font-semibold">{{ $members->where('role', 'wife')->count() }}</span>
                                    </span>
                                    <span class="text-gray-600">
                                        Children: <span class="font-semibold">{{ $members->where('role', 'child')->count() }}</span>
                                    </span>
                                </div>
                            </div>
                        </div>
                    @else
                        ...
                        <div class="text-center py-12">
                            ...
                            <h3 class="mt-4 text-lg font-medium text-gray-900">No family members yet</h3>
                            <p class="mt-2 text-sm text-gray-500">Get started by adding your first family member (Wife or Child).</p>
                            <div class="mt-6">
                                <a href="{{ route('family.create') }}"
            ...
            <div class="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div class="flex items-start">
                    ...
                    <div class="ml-3">
                        <h4 class="text-sm font-medium text-blue-800">Family Management</h4>
