    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-text-input id="family_name" class="block mt-1 w-full" type="text" name="family_name"
                :value="old('family_name')" required autofocus autocomplete="organization" />
            <x-input-error :messages="$errors->get('family_name')" class="mt-2" />
            <p class="mt-1 text-sm text-gray-600">Enter your family name (e.g., "Smith Family" or "Johnson's")</p>
        </div>
