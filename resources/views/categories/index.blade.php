    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h3 class="text-2xl font-bold text-gray-900">Manage Transaction Categories</h3>
                    <p class="mt-1 text-sm text-gray-600">Organize your income and expense transactions by creating
                        custom categories</p>
                </div>
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @foreach($incomeCategories as $category)
                                            <tr>
                                                ...
                                                <td class="px-4 py-3 whitespace-nowrap">
                                                    <div class="text-sm text-gray-900">{{ $category->user->name }}</div>
                                                </td>
                                                @if(auth()->user()->isOwner())
