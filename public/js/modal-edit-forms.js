 ...
 * Provides HTML form templates for different resource types with dark mode support
 */
    ...
    return `
        <form id="edit-form" method="POST" action="/categories/${data.id}">
            ...
            <div class="mb-6">
                ...
                <p class="error-message hidden mt-1 text-sm text-red-600 dark:text-red-400" data-field="name"></p>
            </div>
            ...
            <div class="mb-6">
                ...
                <p class="error-message hidden mt-1 text-sm text-red-600 dark:text-red-400" data-field="type"></p>
            </div>
            ...
            <div class="mb-6">
                ...
                <p class="error-message hidden mt-1 text-sm text-red-600 dark:text-red-400" data-field="description"></p>
            </div>

            ${data.transactions_count > 0 ? `
            <div class="bg-yellow-50 dark:bg-yellow-900/30 border-l-4 border-yellow-400 dark:border-yellow-500 p-4">
...
function getTransactionFormHtml(data) {
    ...
    return `
        <form id="edit-form" method="POST" action="/transactions/${data.id}">
            ...
            <!-- Category -->
            <div class="mb-6">
                <label for="edit-category_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                ...
                <p class="error-message hidden mt-1 text-sm text-red-600 dark:text-red-400" data-field="category_id"></p>
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Select transaction type first to filter categories</p>
            </div>

            <!-- Amount -->
            <div class="mb-6">
                <label for="edit-amount" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                ...
                <input type="number" name="amount" id="edit-amount" value="${data.amount || ''}"
                    ...
                    class="block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                    placeholder="0.00">
                <p class="error-message hidden mt-1 text-sm text-red-600 dark:text-red-400" data-field="amount"></p>
            </div>

            <!-- Transaction Date -->
            <div class="mb-6">
                <label for="edit-transaction_date" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                    Transaction Date <span class="text-red-500">*</span>
                </label>
                <input type="date" name="transaction_date" id="edit-transaction_date" value="${data.transaction_date || ''}" required
                    class="block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                <p class="error-message hidden mt-1 text-sm text-red-600 dark:text-red-400" data-field="transaction_date"></p>
            </div>
            ...
            <div class="mb-6">
                ...
                <p class="error-message hidden mt-1 text-sm text-red-600 dark:text-red-400" data-field="notes"></p>
            </div>
        </form>
    `;
}
...
function getFamilyFormHtml(data) {
    return `
        <form id="edit-form" method="POST" action="/family/${data.id}">
            ...
            <div class="mb-6 flex items-center space-x-4 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                ...
                <div>
                    <p class="text-sm text-gray-500 dark:text-gray-400">Editing member</p>
                    <p class="font-semibold text-gray-900 dark:text-gray-100">${data.name || ''}</p>
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="text" name="name" id="edit-name" value="${data.name || ''}" required
                    class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                <p class="error-message hidden mt-1 text-sm text-red-600 dark:text-red-400" data-field="name"></p>
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="email" name="email" id="edit-email" value="${data.email || ''}" required
                    class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                <p class="error-message hidden mt-1 text-sm text-red-600 dark:text-red-400" data-field="email"></p>
            </div>
            ...
            <div class="mb-6">
                ...
                <p class="error-message hidden mt-1 text-sm text-red-600 dark:text-red-400" data-field="role"></p>
            </div>

            <!-- Password Reset Section -->
            <div class="mb-6 p-4 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700/50">
                <div class="flex items-start mb-4">
                    <svg class="w-5 h-5 text-indigo-500 dark:text-indigo-400 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                    </svg>
                    <div class="flex-1">
                        <h4 class="text-sm font-semibold text-gray-900 dark:text-gray-100">Reset Password (Optional)</h4>
                        <p class="mt-1 text-xs text-gray-600 dark:text-gray-400">Leave blank if you don't want to change the password.</p>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <p class="error-message hidden mt-1 text-sm text-red-600 dark:text-red-400" data-field="password"></p>
                </div>

                <!-- Confirm Password -->
                <div>
                    <label for="edit-password_confirmation" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
